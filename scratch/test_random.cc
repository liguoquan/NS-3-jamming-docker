...
NS_LOG_COMPONENT_DEFINE ("RandomJamming");
...
int main (int argc, char *argv[]){
  ...
  outfile.open("random.log",ios::trunc);
  ...
  wifiChannel.SetPropagationDelay ("ns3::RandomPropagationDelayModel","Variable", RandomVariableValue (UniformVariable (0.0, 0.01)));
  ...
  jammerHelper.SetJammerType("ns3::RandomJammer");
